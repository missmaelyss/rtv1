...
/*   Updated: 2017/07/26 12:25:32 by ele-cren         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <rt.h>

static void	ft_copy_col_text(t_env *env, int i)
{
...
static void	ft_col_text2(t_env *env, int i, char **name)
{
...
static void	ft_col_text(t_env *env)
{
	int		i;
	char	*name;
